      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
        {filtered.map((item) => (
          ...
          >
            ...
            {/* Quick Action Overlay: visible on mobile, hover on desktop */}
            <div className="absolute right-2 top-2 z-10 flex gap-1.5 opacity-100 transition sm:opacity-0 sm:group-hover:opacity-100">
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-black/80 text-white shadow-md backdrop-blur transition active:scale-95 hover:bg-amber-400 hover:text-[#0a1633]"
                title="Edit details"
              >
                <Edit3 size={14} />
              </button>
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-black/80 text-rose-300 shadow-md backdrop-blur transition active:scale-95 hover:bg-rose-600 hover:text-white"
                title="Delete image"
              >
                <Trash2 size={14} />
              </button>
